...
class FGlobalInteractor(nn.Module):
    ...
    def __init__(self,
        ...
        super(FGlobalInteractor, self).__init__()
        ...
        self.global_interactor_layers = nn.ModuleList(
            [FGlobalInteractorLayer(embed_dim=embed_dim, num_heads=num_heads, dropout=dropout)
    ...
    def forward(self,
                data: TemporalData,
                local_embed: torch.Tensor, y_hat: torch.Tensor) -> torch.Tensor:
        ...
        rel_pos = positions_future[edge_index[0], self.historical_steps - 1] - positions_future[
...
class FGlobalInteractorLayer(MessagePassing):
    ...
    def __init__(self,
                 ...
                 dropout: float = 0.1,
                 **kwargs) -> None:
        super(FGlobalInteractorLayer, self).__init__(aggr='add', node_dim=0, **kwargs)
        self.embed_dim = embed_dim
