...
class LocalEncoder(nn.Module):
    ...
    def forward(self, data: TemporalData) -> torch.Tensor:
        ...
        #edge_index_max, edge_attr_max = self.drop_edge(data['lane_actor_index_max'], data['lane_actor_vectors_max'])
        out_init = self.al_encoder(x=(data['lane_vectors'], out), edge_index=edge_index, edge_attr=edge_attr,
        ...
        """out_max = self.al_encoder(x=(data['lane_vectors'], out_init), edge_index=edge_index_max, edge_attr=edge_attr_max,
                              is_intersections=data['is_intersections'], turn_directions=data['turn_directions'],
                              traffic_controls=data['traffic_controls'], rotate_mat=data['rotate_mat'])"""
        return out_init
